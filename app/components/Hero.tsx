      ...
      <div className="heroGrid">
        <div className="heroCopy">
          ...
          <div className="heroActions">
            <a className="heroCta" href="/branches" onClick={() => trackEvent("branch_cta_click", { placement: "hero" })}><span className="heroCtaLogo"><Image src="/images/cake-city-web-logo.png" alt="" width={803} height={381} /></span><span>Find my branch</span><ArrowDown /></a>
